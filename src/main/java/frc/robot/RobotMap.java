...
public class RobotMap {
  ...
  // Driver Sitck Information 
  public static Joystick driverStick; // The name of the joystick
  public static int JoyStickLever_Port = 0; // Thr driver station item slot this controler resides in
  public static int JoyStickLever_throaxis = 1; // This axis for thro
  public static int JoyStickLever_yawaxis = 2; // The axis for yaw
